...
class ArgumentParser(object):
    def __init__(self, script_path):
        ...
        self.DBOutputFile = options.DBOutputFile
    ...
    def parseConfig(self):
        ...
        self.autoSaveFormat = config.safe_get("reports", "autosave-report-format", "plain", ["plain", "json", "simple", "DB"])
        # Dictionary
    ...
    def parseArguments(self):
        ...
        reports.add_option('--database-report', action='store',
                           help="store findings to DB", dest='DBOutputFile', default=None)
